...
Furthermore, plots showing how much of the variation each PC accounts for were made using the following R code:

```{r eval=FALSE}
library(ggplot2) #loading ggplot

eigenval <- read.table("ALL_PCAIR.eigenval", header=T, nrows=10) #reads the first 10 rows of the eigenval file
...
![5. PCA plot for CAU pop](assets/CAU_PCAIR_PC1_VS_PC2.png)

![6. Variation explained by the first 10 PCs](assets/CAU_PCprop.png)

***

### CHN

![7. PCA plot for CHN pop](assets/CHN_PCAIR_PC1_VS_PC2.png)

![8. Variation explained by the first 10 PCs](assets/CHN_PCprop.png)

***

### HIS

![9. PCA plot for HIS pop](assets/HIS_PCAIR_PC1_VS_PC2.png)

![10. Variation explained by the first 10 PCs](assets/HIS_PCprop.png)