...
The first QC step consists of filtering out variants with low call rate.  
...
```{r eval=FALSE}
plink --bfile MESA_nonauto --geno 0.01 --make-bed --out MESA_missfilt
```
New bim/bed/fam files were generated filtering out variants with missing call rates above 0.01. 1113 out of 37266 (~2.99%) variants were removed. 
